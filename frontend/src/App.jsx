...
import ConsumerResultsPage from "./pages/ConsumerResultsPage";
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/select-competitor" element={<SelectCompetitorPage />} />
                <Route path="/competitor-analysis" element={<CompetitorAnalysisPage />} />
                <Route path="/consumer-results" element={<ConsumerResultsPage />} />
